...
public class PlayersService {
    ...
    @Autowired
    public void setPlayerRepository(PlayersRepository playersRepository) {
    ...
    public Player findPlayerByID(Long id) {
        ...
        return playersRepository.findById(id).orElseThrow(() -> new NotFoundException("Player not found"));
    }
